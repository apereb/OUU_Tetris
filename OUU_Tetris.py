...
class Jeu:
    ...
    def valid_mute(self, placements):
        ...
        for rot in rotations:
            ...
            for y in range(H - hauteur_piece + 1):
                for x in range(4 - largeur_piece + 1):
                    ...
                    if not self.valid_mute(placements_str):
    ...
    def all_state(self):
        ...
        while queue:
            ...
            if idx_attente not in seen:
                ...
                next, term = self.placements_possibles(self.state_to_idx(attente[0], attente[1]))
